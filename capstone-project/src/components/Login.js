...
handleLoginSumbit = (e) => {
  ...
  render(){
    return(
     ...
     <div style={{width: '30em', height: '20em', margin: 'auto', marginTop: '7em', border: 'solid #1598AF', borderWidth: 'thin', padding: '1em', marginBottom: '2em',backgroundColor: 'rgba(0,151,201, 0.4)'}}>
     <Form onSubmit={this.handleLoginSumbit}>
      ...
      <button style={{color: '#1598AF', marginTop: '1em'}}>Submit</button>
    </Form>
    </div>
