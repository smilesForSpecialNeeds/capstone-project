          ...
          <Row >
            <Col xs="6">
              ...
              <Media style={{
                  ...
                  border: 'solid',
                  borderWidth: 'thin'
                }} img="img" className="aboutImage" src="http://smilesforspecialneeds.com/images/748e45bd21ab07bd7d1f273d1e78d5d4_qkys.jpg"/>
            ...
            <Col xs="6">
              <Media style={{
                ...
                <Media img="img" className="aboutImage" src="http://smilesforspecialneeds.com/images/9035c4ce2a8ac666998c701e71af8a0c.jpg" style={{
                    maxHeight: '50vh',
                    objectFit: 'cover',
                    paddingBottom: '0',
                    marginLeft: '50px',
