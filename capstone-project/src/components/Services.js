        ...
        <Media style={{
          ...
          <Row >
            ...
            <Col xs="6">
              ...
              <Media>
                <Media img="img" className="aboutImage" src={theImage14} style={{
                    maxHeight: '50vh',
                    objectFit: 'cover',
                    paddingBottom: '0',
                    marginLeft: '20px',
