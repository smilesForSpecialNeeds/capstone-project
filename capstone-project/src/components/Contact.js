        ...
        <Media style={{
          ...
          <Row>
            <Col xs="6" style={{
              ...
              <div >
                ...
                <h4>
                  ...
                  is to serve individuals who have special needs with commitment, respect and a passion to help them see their fullest potential.
                </h4>
                <p/>
                ...
                <div style={{
                  ...
                  <h5 style={{
                    ...
                    <strong>2424 E Southern Ave.</strong>
                  </h5>
                  <h5 style={{
                      color: '#0097C9'
                    }}>
                    <strong>Mesa, Arizona 85204</strong>
                  </h5>
                  <h5 style={{
                      color: '#0097C9'
                    }}>
                    <strong>Phone (480) 361-1972 Fax (866)579-0262</strong>
                  </h5>
                  <h5 style={{
                      color: '#0097C9'
                    }}>
                    <strong>Email: smilesforspecialneeds@gmail.com</strong>
                  </h5>
                </div>
                <div style={{
                    marginTop: '5em'
            ...
            <Col xs="6" style={{
              ...
              <h4>
                At
                <strong>Smiles for Special Needs</strong>, we believe that our employees are the best in the industry. We are always looking for individuals who have a desire to serve individuals with intellectual and developmental delays. Compensation is based on experience. Training is provided.</h4>
              <h4>Please contact us at
                <strong>Info@Smilesforspecialneeds.com</strong>
              ...
              <h3>
                <a href="#"><img className="hover-contact" style={{
        verticalAlign: 'middle',
        height: '3em',
        marginBottom: '3em',
        marginTop: '1em',
