           ...
           <Form style={{  fontSize:'20px', color:'#1476A8',padding: '1em', marginLeft: '1em', marginRight: '3em', marginTop: '3em', marginBottom: '1em'}} onSubmit={this.handleSubmitUpdate}>
                ...
                <FormGroup row >
                  ...
                  <Col sm={10}>
                    ...
                    onChange={(e)=> this.setState({address: e.target.value})} id="exampleTitle" placeholder="Pickup Address" />
                  </Col>
                </FormGroup>
                ...
                <FormGroup row>
                  ...
                  <Col sm={10}>
                    ...
                    onChange={(e)=> this.setState({child_img: e.target.value})} id="exampleDate" placeholder="Hours Type" />
                  </Col>
                </FormGroup>
                <FormGroup row>
                  <Label for="exampleDate" sm={2}></Label>
                  <Col sm={10}>
                    ...
                    onChange={(e)=> this.setState({notes: e.target.value})} id="exampleDate" placeholder="Pickup Time" />
                  </Col>
                </FormGroup>
