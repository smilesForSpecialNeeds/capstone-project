...
render(){
  return(
    <div>
    <div style={{width: '30em', height: '35em', margin: 'auto', marginTop: '5em', border: 'solid #1598AF',borderWidth: 'thin', padding: '1em', marginBottom: '3em', backgroundColor: 'rgba(0,151,201, 0.4)'}}>
    ...
    <Form onSubmit={this.handleRegistrationSubmit}>
     ...
     <FormGroup>
       ...
       <Input type="name" value={this.state.name} onChange={(e) => this.setState({name: e.target.value})}name="name" id="exampleName" placeholder="Name" />
     </FormGroup>
     <FormGroup>
     ...
     <button style={{color: '#1598AF', marginTop: '1em'}} type="Submit">Submit</button>
   </Form>
   </div>
