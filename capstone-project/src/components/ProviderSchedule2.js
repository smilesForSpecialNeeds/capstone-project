                ...
                <Form style={{
                  ...
                  <FormGroup row="row">
                    ...
                    <Col sm={10}>
                      <Input style={{
                          height: '20em'
                        }} type="textarea" name="note" value={this.state.notes} onChange={(e) => this.setState({notes: e.target.value})} id="exampleTitle" placeholder="Enter Note"/>
                    </Col>
                  </FormGroup>
