...
handleSubmit = (e) => {
  ...
  render(){
    console.log('LOOK',this.props.calendar)
    return(
      <div>
      <Form style={{ marginRight:'50%', marginLeft:'1em', marginBottom:'50px', fontSize:'20px', color:'#1476A8'}} onSubmit={this.handleSubmitUpdate}>
        ...
        <Button  style={{marginLeft:'12em', marginBottom:'10px', marginRight:'430px', color:'#1476A8'}} onClick={this.handleSubmit}>Submit</Button>
        </Form>
      </div>
    )
  }
